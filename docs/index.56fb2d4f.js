 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Wn.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new It(e));return t.isEmpty()?null:t.value?new zn(this.source,Et(),t.value):new Vn(this.source,Et(),t)}return i(kt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Vn(this.source,Nt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wr={};let Ur=!1;function jr(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),je("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,h=Tr(r,s),l=h.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${l.namespace}`,h=Tr(r,s),l=h.repoInfo):o=!h.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Gs("Invalid Firebase Database URL",h),At(h.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Wr[t.name];s||(s={},Wr[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new tr(e,Ur,n,i),s[e.toURLString()]=r,r}(l,e,c,new st(e.name,n));return new Hr(u,e)}class Hr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Pr(this._repo,Et())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Wr[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ur(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}Ht.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ht.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.9","app");const Br=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(k(e,s.options)&&k(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyCWwqJv87aGIrLWgNo39SlKHTsjPAXiNw4",authDomain:"my-things-to-do-app.firebaseapp.com",databaseURL:"https://my-things-to-do-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"my-things-to-do-app",storageBucket:"my-things-to-do-app.appspot.com",messagingSenderId:"1049471641136",appId:"1:1049471641136:web:b560312b45b1a349ed6ff5"}));class zr{constructor(e,t,n){this.id=e,this.task=t,this.done=n,this.displayTasks()}displayTasks(){const e=document.querySelector("#tasks-div"),t=document.createElement("h3"),n=document.createElement("button"),i=document.createElement("div");t.innerText=this.task,n.innerText="X",n.className="delete-btn",i.className="task-container",i.id=this.id,this.done&&(t.style.textDecorationLine="line-through"),t.addEventListener("click",(()=>{console.log("h3 clicked"),this.toggleDone()})),n.addEventListener("click",(()=>{console.log("delete btn clicked");!function(e){Ys("remove",e._path),Ar(e,null)}(Rr(Br,"/my_todos/"+this.id))})),i.append(t),i.append(n),e.append(i),document.body.append(e)}toggleDone(){this.done=!this.done;const e=Rr(Br,"/my_todos/"+this.id),t={};t["/done"]=this.done,Mr(e,t)}clearTask(){document.querySelector(`#${this.id}`).remove()}}console.log(Br);const Vr=Rr(Br,"/my_todos");let $r=[];qr(Vr,(e=>{const t=e.val();console.log("todo Data:"),console.log(t);for(const e of $r)e.clearTask();$r=[];for(const e in t)$r.push(new zr(e,t[e].task,t[e].done));console.log($r)}));document.querySelector("#add-task-btn").addEventListener("click",(e=>{const t=document.querySelector("#input-task");e.preventDefault();const n={task:t.value,done:!1};t.value="";const i={};i[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Ar(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(Vr).key]=n,Mr(Vr,i)}));
//# sourceMappingURL=index.56fb2d4f.js.map
